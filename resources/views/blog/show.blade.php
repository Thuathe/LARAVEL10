						...
						<ul>
							...
							<li class="has-dropdown">
								...
								<ul class="dropdown">
									...
									<li><a href="#{{ $blog->title }}">{{ $blog->title }}</a></li>
							...
							<li class="has-dropdown">
								...
								<ul class="dropdown">
									...
									<li><a href="#example">{{ $blog->title }}</a></li>
					...
					<div id="example"class="col-12">
						...
						<section>
							...
							<div class="row">
								...
								<div style="width:100%;"id="{{ $blog->title }}" class="col-6 col-12-small">
									<section class="box">
										<img style="width:25%;" src="{{ asset('/storage/blog/'.$blog->image) }}" alt="" />
										<br><br>
										<p style="min-height: 250px;"><a style="text-decoration:none;color:#ea272d;font-weight:bold;font-size:30px;">{{ $blog->title }}</a>{!! $blog->content !!}</p>
										
												<P id="example">EXAMPLE:</P>
											<img style="width:60%;" src="{{ asset('/storage/blog/'.$blog->example) }}" alt="" />
