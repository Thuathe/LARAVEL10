						...
						<ul>
							...
							<li class="has-dropdown">
								...
								<ul class="dropdown">
									...
									<li><a href="#{{ $blog1->title }}">{{ $blog1->title }}</a></li>
									@empty
									@endforelse
							...
							<li class="has-dropdown">
								...
								<ul class="dropdown">
								@forelse ($blog as $blog1)
									<li><a href="{{ route('blog.show', $blog1->id) }}">{{ $blog1->title }}</a></li>
									@empty
								@endforelse
							...
							<div class="row">
								...
								<div class="col-4 col-6-medium col-12-small">
									<section style="width:100%" class="	box">
										<a href="#{{ $blog1->title }}">
											<img style="width: 30%;" src="{{ asset('/storage/blog/'.$blog1->image) }}" alt="" />
											<h2 style="width:60%;font-size:20px;margin-top:10px;float:right;">{{ $blog1->title }}</h2>
										</a>
									</section>
								</div>
								@empty
					...
					<div id="example"class="col-12">
						...
						<section>
							...
							<div class="row">
								...
								<div id="{{ $blog1->title }}" class="col-6 col-12-small">
									<section class="box">
										<img style="width:25%;" src="{{ asset('/storage/blog/'.$blog1->image) }}" alt="" />
										<br><br>
										<p style="min-height: 350px;"><a style="text-decoration:none;color:#ea272d;font-weight:bold;font-size:30px;">{{ $blog1->title }}</a>{!! $blog1->content !!}</p>
										<footer>
											<ul class="actions">

											</ul>
										</footer>
									<a href="{{ route('blog.show', $blog1->id) }}" style="background-color:#ea272d;"class="button icon solid fa-file-alt">Show More</a></li>
