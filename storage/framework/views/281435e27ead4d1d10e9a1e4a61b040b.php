    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-body">
                    <a href="<?php echo e(route('post.create')); ?>" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">
                                    <img src="<?php echo e(asset($post1->image)); ?>" class="rounded" style="width:150px">
                                </td>
...
confirm('Apakah Anda Yakin ?');" action="<?php echo e(route('post.destroy', $post1->id)); ?>" method="POST">
                                        <a href="<?php echo e(route('post.show', $post1->id)); ?>" class="btn btn-sm btn-dark">SHOW</a>
                                        <a href="<?php echo e(route('post.edit', $post1->id)); ?>" class="btn btn-sm btn-primary">EDIT</a>
                                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL10\resources\views/post/index.blade.php ENDPATH**/ ?>